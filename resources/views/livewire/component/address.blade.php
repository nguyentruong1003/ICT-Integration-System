            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col">
                            <select wire:model.lazy="district_id" name='district' id="supplyDistrict" class="form-control-sm form-control" {{$status?'disabled':''}}>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col">
                            <select wire:model.lazy="ward_id" id="supplyWard" name='ward' class="form-control-sm form-control" {{$status?'disabled':''}}>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col">
                            <input id="Address" wire:model="address" name='address' placeholder="Địa chỉ cụ thể" type="text" class="form-control form-control-sm " {{$status?'disabled':''}}>
                        </div>
                    </div>
                </div>
            </div>
