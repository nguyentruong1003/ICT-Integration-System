...
@section('title')
    <title>{{__('data_field_name.role.create')}}</title>
@endsection
@section('content')
    <div class="body-content p-2">
        <div class="p-2 pb-3 d-flex align-items-center justify-content-between">
            <div class="">
                <h4 class="m-0">{{__('data_field_name.role.create')}}</h4>
            </div>
            <div class="paginate">
                <div class="d-flex">
                    <div class="">
    ...
    {!! Form::model(null, ['method' => 'POST', 'autocomplete' => "off",'route' => ['admin.system.role.store']]) !!}
